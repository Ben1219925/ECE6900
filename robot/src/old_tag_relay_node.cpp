...
public:
    TagRelayNode() : Node("tag_relay_node") {
        ...
        sub_ = this->create_subscription<AprilTagArray>(
        ...
        RCLCPP_INFO(this->get_logger(), "Tag Relay Node Started (Dual Frame Mode).");
    }
...
private:
   void tag_callback(const AprilTagArray::SharedPtr msg) {
    ...
    rclcpp::Subscription<AprilTagArray>::SharedPtr sub_;
